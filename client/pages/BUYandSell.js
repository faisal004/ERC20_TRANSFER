...
const BUYandSell = () => {
  ...
  return (
    <div>
      {currentAccount ? (
        <div className=" bg-gradient-to-r from-black to-blue-900 h-screen items-center justify-center md:flex flex-row space-x-10">
          ...
          <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
              ...
              <div>
      <label className="block mb-2  py-1  text-sm font-mono  font-medium text-gray-900 dark:text-white" htmlFor="amount">Enter amount:</label>
      <input
        type="number"
        id="amount"
        name="amount"
      ...
      />
      <br />
      <label className="block mb-2 text-sm font-mono py-1 font-medium text-gray-900 dark:text-white" htmlFor="result">Ether to send/receive:</label>
      <input type="text" id="result" name="result" value={result} disabled />
    </div>
