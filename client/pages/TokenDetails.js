...
const Middle = () => {
    const { NoOfToken,TokenOwner,currentAccount} = useContext(TranferContext);

  return (
    <section className="text-white bg-gradient-to-r from-black to-blue-900 font-mono h-screen">
      <div className="container px-5 py-24 mx-auto">
       {currentAccount?(<div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
