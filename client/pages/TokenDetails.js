  ...
  return (
      ...
      <div className=" w-full items-center justify-center  px-5 py-24 mx-auto text-white bg-gradient-to-r from-black to-blue-900 font-mono h-screen">
        ...
        <ul role="list" className="space-y-5 my-7 ">
          ...
          <li className="flex space-x-3">
            ...
            You can Buy OR Sell MKT token at an exchange rate of 1 MKT = 0.001 Ether
            </span>
          </li>
        </ul>
      </div>
      <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        <h5 className="mb-4 text-xl font-mono font-medium text-white dark:text-white">
          loremipsumsfdbwsd ihffhid fhedif adifadf hoiehr fhaefoihaewrywer ywarktabrlf eruopty arkehgbaejrg hweluoirgfyaourfhgkajgbuie arhgkeajbw3r oleur ghaeur huar hgafngeuaoihytgafnvolhglvhale urgha.kerghlaghhgq{" "}
        </h5>
